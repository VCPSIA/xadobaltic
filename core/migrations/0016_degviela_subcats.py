...
def add_subcats(apps, schema_editor):
    ...
    try:
        parent = NavCategory.objects.get(name_lv='Degvielas sistēma', tab_slug='passenger-cars')
...
def remove_subcats(apps, schema_editor):
    ...
    NavCategory.objects.filter(
        name_lv__in=['Degvielas piedevas', 'Attīrītāji', 'Revitalizanti'],
        tab_slug='passenger-cars', parent__name_lv='Degvielas sistēma',
    ).delete()


class Migration(migrations.Migration):
    dependencies = [('core', '0015_stures_subcats')]
